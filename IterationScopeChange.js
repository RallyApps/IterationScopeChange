var APP_TYPE = 'Iteration';
var START_DATE_NAME = "StartDate";
var END_DATE_NAME = "EndDate";
var ESTIMATE_UNIT_NAME = 'IterationEstimateUnitName';

function IterationScopeChange() {
    ...
    this.display = function() {
        ...
        var config = {showLabel: true,
            label: APP_TYPE};
        dropdown = new rally.sdk.ui.IterationDropdown(config, rallyDataSource);
